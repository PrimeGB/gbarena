...
export default function CallOfDutyPage({ params }: PageProps) {
  const platform = params.platform || "xbox";
    ...
    <>
      <style>{`
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .platform-xbox .wrapper{border-color:#61df67;box-shadow:0 0 35px rgba(0,255,80,.42);}
        .platform-playstation .wrapper{border-color:#3f8dff;box-shadow:0 0 35px rgba(45,120,255,.45);}
        .platform-pc .wrapper{border-color:#d8e6ff;box-shadow:0 0 35px rgba(220,235,255,.36);}
        .platform-nintendo .wrapper{border-color:#ff3434;box-shadow:0 0 35px rgba(255,35,35,.42);}
        ...
        @media(max-width:1120px){.wrapper{width:100%;}}

        @media(max-width:850px){
          .games-grid{grid-template-columns:1fr;}
          .header{flex-direction:column;gap:14px;padding:20px;text-align:center;}
          .nav{height:auto;flex-wrap:wrap;gap:14px;padding:10px;}
          .ladder-item{grid-template-columns:1fr;gap:8px;padding:12px;}
        }
      `}</style>

      <main className={`page ${platformClass(platform)}`}>
                        ...
                        return (
                          ...
                          >
                            ...
                            <a
                              ...
                              href={`/team-hub?platform=${platform}&category=call-of-duty&game=${game.slug}&ladder=${currentLadderSlug}`}
                            >
                              View/Create Team
                            </a>
                            ...
                            <a
                              className="ladder-link"
                              href={`/ladders/${platform}/call-of-duty/${game.slug}/${currentLadderSlug}/rankings`}
                            >
