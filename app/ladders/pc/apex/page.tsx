...
const apexTitles = [
  {
    ...
    slug: "battle-royale",
    image:
      "https://media.contentapi.ea.com/content/dam/apex-legends/common/articles/apex-legends-media/apex-media-wallpaper-4.jpg.adapt.crop191x100.1200w.jpg",
    ladders: ["Duos", "Trios"],
  },
  {
    ...
    slug: "ranked",
    image:
      "https://media.contentapi.ea.com/content/dam/apex-legends/common/articles/apex-legends-media/apex-media-wallpaper-2.jpg.adapt.crop191x100.1200w.jpg",
    ladders: ["Duos", "Trios"],
  },
  {
    title: "Apex Legends Mixtape",
    slug: "mixtape",
    image:
      "https://media.contentapi.ea.com/content/dam/apex-legends/common/apex-section-bg-blue-xl.jpg.adapt.crop191x100.1200w.jpg",
    ladders: ["Team Deathmatch", "Control", "Gun Run"],
  },
  {
    title: "Apex Legends Wildcard",
    slug: "wildcard",
    image:
      "https://media.contentapi.ea.com/content/dam/apex-legends/common/articles/apex-legends-media/apex-media-wallpaper-1.jpg.adapt.crop191x100.1200w.jpg",
    ladders: ["Trios", "Squads"],
  },
];
...
> = {
  xbox: {
    name: "Xbox",
    title: "Xbox Apex Legends Ladders",
    markClass: "xbox-mark",
    backgroundGlow:
  ...
  playstation: {
    name: "PlayStation",
    title: "PlayStation Apex Legends Ladders",
  ...
  nintendo: {
    name: "Nintendo",
    title: "Nintendo Apex Legends Ladders",
...
export default function ApexLaddersPage() {
      ...
      <main className="page">
        <div className="wrapper">
          ...
          <section className="title-bar">
            ...
            <p>
              Choose an Apex Legends mode below. Each mode has its own teams,
              ladders, matches, and standings.
            </p>

            <div className="info-note">
              Apex currently centers around Battle Royale Duos/Trios, Ranked,
              and Mixtape modes like Team Deathmatch, Control, and Gun Run.
            </div>
          </section>
              ...
              {apexTitles.map((game) => (
                <div className="game-card" key={game.title}>
                  ...
                  <a
                    ...
                    href={`/ladders/${platformKey}/apex/${game.slug}`}
                  >
                  ...
                  <div className="card-body">
                    <div className="ladder-list">
                      {game.ladders.map((ladder) => {
                        ...
                        const teamHubUrl = `/team-hub?platform=${platformKey}&category=apex&game=${game.slug}&ladder=${currentLadderSlug}`;

                        const rankingsUrl = `/ladders/${platformKey}/apex/${game.slug}/${currentLadderSlug}/rankings`;
