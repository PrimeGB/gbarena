...
export default function TeamPage() {
  ...
  // Sort upcoming & playing matches to the top, while keeping recent matches listed below them
  const visibleMatches = useMemo(() => {
    return [...teamMatches].sort((a, b) => {
      const aStat = resultText(a, teamId);
      const bStat = resultText(b, teamId);
      const aIsLive = aStat === "Upcoming" || aStat === "Playing" ? 1 : 0;
      const bIsLive = bStat === "Upcoming" || bStat === "Playing" ? 1 : 0;
